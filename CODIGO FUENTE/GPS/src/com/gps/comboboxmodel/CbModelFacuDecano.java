 ...
 */
public class CbModelFacuDecano extends AbstractListModel implements MutableComboBoxModel{
    private Object selectedItem;
    private ArrayList<Facultad> data = new ArrayList();

    public CbModelFacuDecano() {
    }

    public CbModelFacuDecano(ArrayList<Facultad> datos) {
        data = datos;        
    }
    ...
    public Object getElementAt(int index) {
        return (Object) data.get(index).getSiglas()+"  /  "+data.get(index).getDescripcion();
    }
