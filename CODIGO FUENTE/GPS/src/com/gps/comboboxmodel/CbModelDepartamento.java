 ...
 */
public class CbModelDepartamento extends AbstractListModel implements MutableComboBoxModel{
    private Object selectedItem;
    private ArrayList<Ubigeo> data = new ArrayList();

    public CbModelDepartamento() {
    }

    public CbModelDepartamento(ArrayList<Ubigeo> datos) {
        data = datos;        
    }
    ...
    public Object getElementAt(int index) {
        return (Object) data.get(index).getDepartamento();
    }
