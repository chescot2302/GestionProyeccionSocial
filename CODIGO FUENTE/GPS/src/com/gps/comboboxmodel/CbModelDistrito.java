 ...
 */
public class CbModelDistrito extends AbstractListModel implements MutableComboBoxModel{
    private Object selectedItem;
    private ArrayList<Ubigeo> data = new ArrayList();

    public CbModelDistrito() {
    }

    public CbModelDistrito(ArrayList<Ubigeo> datos) {
        data = datos;        
    }
    ...
    public Object getElementAt(int index) {
        return (Object) data.get(index).getDistrito();
    }
