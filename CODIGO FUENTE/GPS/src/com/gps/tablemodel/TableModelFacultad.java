 ...
 */
public class TableModelFacultad extends AbstractTableModel {

    private ArrayList<String> headerTable = new ArrayList();
    private ArrayList<Facultad> data = new ArrayList();
    private ArrayList<TableModelListener> listeners = new ArrayList();
    private JTable tablaDatos;    
    private HashSet <Facultad> listaCommit=new HashSet ();    
    public TableModelFacultad(JTable tabla) {
        tablaDatos=tabla;
        createHeaders();        
    }

    public TableModelFacultad(JTable tabla,ArrayList<Facultad> lista) {
        tablaDatos=tabla;
        data = lista;
        createHeaders();        
    }
    ...
    public void insertar(Facultad i) {
        data.add(i);
        TableModelEvent evento;
    ...
    public void update(Facultad i, int fila) {
        data.remove(fila);
        data.add(fila, i);
        TableModelEvent evento;
    ...
    public Facultad getValue(int rowIndex) {
        try {
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) { 
        String aux;
        String valor;        
        Facultad auxObj=data.get(rowIndex);        
       ...
       try{
           ...
           while(iterar.hasNext()){
               Facultad bean=(Facultad)iterar.next();               
    ...
    public HashSet<Facultad> getListaCommit() {
        return listaCommit;
    }
