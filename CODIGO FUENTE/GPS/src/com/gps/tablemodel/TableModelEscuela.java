...
import com.gps.util.CellEditorCbFacultad;
 ...
 */
public class TableModelEscuela extends AbstractTableModel {

    private ArrayList<String> headerTable = new ArrayList();
    private ArrayList<Escuela> data = new ArrayList();
    private ArrayList<TableModelListener> listeners = new ArrayList();
    private JTable tablaDatos;    
    private HashSet <Escuela> listaCommit=new HashSet ();    
    public TableModelEscuela(JTable tabla) {
        tablaDatos=tabla;
        createHeaders();        
    }

    public TableModelEscuela(JTable tabla,ArrayList<Escuela> lista) {
        tablaDatos=tabla;
        data = lista;
        createHeaders();        
    }
    ...
    public void insertar(Escuela i) {
        data.add(i);
        TableModelEvent evento;
    ...
    public void update(Escuela i, int fila) {
        data.remove(fila);
        data.add(fila, i);
        TableModelEvent evento;
    ...
    public Escuela getValue(int rowIndex) {
        try {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 3:
                return data.get(rowIndex).getFacultad().getSiglas();                                  
            case 4:
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) { 
        String aux;
        String valor;        
        Escuela auxObj=data.get(rowIndex);
        Facultad auxFac=null;
        Facultad fac=null;
       ...
       switch (columnIndex) {
            ...
            case 2:         
                ...
                break;
            case 3:                   
                auxFac=(Facultad)aValue;
                System.out.println("Este es el valor: "+auxFac);
                if(aValue!=null){
                if(!data.get(rowIndex).getEstadoOperacion().equals("i")){
                fac=data.get(rowIndex).getFacultad();                   
                data.get(rowIndex).setFacultad(auxFac);                
                if(fac.equals(auxFac)){
                    data.get(rowIndex).setEstadoOperacion("n");
                }else{
                    data.get(rowIndex).setEstadoOperacion("a");
                }
       ...
       try{
           ...
           while(iterar.hasNext()){
               Escuela bean=(Escuela)iterar.next();               
    ...
    public ArrayList<Escuela> getData() {
        return data;
    }

    public void setData(ArrayList<Escuela> data) {
        this.data = data;
    ...
    public HashSet<Escuela> getListaCommit() {
        return listaCommit;
    }
