 ...
 */
public class TablaModelEstado extends AbstractTableModel {

    private ArrayList<String> headerTable = new ArrayList();
    private ArrayList<Estado> data = new ArrayList();
    private ArrayList<TableModelListener> listeners = new ArrayList();
    private JTable tablaDatos;    
    private HashSet <Estado> listaCommit=new HashSet ();    
    public TablaModelEstado(JTable tabla) {
        tablaDatos=tabla;
        createHeaders();        
    }

    public TablaModelEstado(JTable tabla,ArrayList<Estado> lista) {
        tablaDatos=tabla;
        data = lista;
        createHeaders();        
    }
    ...
    public void update(Estado i, int fila) {
        data.remove(fila);
        data.add(fila, i);
        TableModelEvent evento;
    ...
    public Estado getValue(int rowIndex) {
        try {
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) { 
        String aux;
        String valor;        
        Estado auxObj=data.get(rowIndex);        
       ...
       try{
           ...
           while(iterar.hasNext()){
               Estado bean=(Estado)iterar.next();               
    ...
    public ArrayList<Estado> getData() {
        return data;
    }

    public void setData(ArrayList<Estado> data) {
        this.data = data;
    ...
    public HashSet<Estado> getListaCommit() {
        return listaCommit;
    }
