...
public class TableModelDocente extends AbstractTableModel {
    ...
    private ArrayList<Docente> data = new ArrayList();
    private ArrayList<TableModelListener> listeners = new ArrayList();

    public TableModelDocente() {
        createHeaders();
    }

    public TableModelDocente(ArrayList<Docente> lista) {
        data = lista;
        createHeaders();
    }
    ...
    public void insertar(Docente obj) {
        data.add(obj);
        TableModelEvent evento;
    ...
    public void updateo(Docente obj, int fila) {
        data.remove(fila);
        data.add(fila, obj);
        TableModelEvent evento;
    ...
    public Docente getValue(int rowIndex) {
        try {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 6:
                return data.get(rowIndex).getGrado().getDescripcion();            
            default:
                return null;
        }
    }
    ...
    public ArrayList<Docente> getData() {
        return data;
    }

    public void setData(ArrayList<Docente> data) {
        this.data = data;
    }
